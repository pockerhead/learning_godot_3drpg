...
### v1.3 - Система переходов между уровнями и лут
- ✨ Добавлена система переходов между уровнями (Passage)
- ✨ Реализован SceneTransition с анимацией fade
- ✨ Создана система PersistentData для сохранения прогресса между сценами
- ✨ Добавлен новый уровень CastleLevel
- ✨ Реализована система лута и контейнеров (LootContainer)
- ✨ Система сохранения/восстановления экипировки и здоровья
- ✨ Визуальные порталы для перехода между локациями
- 🔧 Улучшена архитектура синглтонов (autoload)
...
- ✅ Система порталов (Passage) для перехода между локациями
- ✅ Плавные анимации перехода с fade эффектом
- ✅ Сохранение состояния игрока между сценами
- ✅ Восстановление экипировки, здоровья и золота
- ✅ Автоматическая загрузка сохраненных данных

### Система лута
- ✅ Контейнеры с лутом (LootContainer)
- ✅ Отображение содержимого контейнеров в UI
- ✅ Система получения предметов и золота
...
- ✅ Множественные уровни (level, CastleLevel)
...
├── passage.gd            # Система переходов
└── passage.tscn          # Сцена портала
...
├── loot_container_display.gd # UI лут контейнеров
└── user_interface.tscn   # Сцена интерфейса

Resources/                 # Игровые ресурсы
└── CharacterStats.gd     # Система характеристик

Autoload/                  # Глобальные системы (синглтоны)
├── vfx_manager.gd        # Менеджер визуальных эффектов
├── scene_transition.gd   # Система переходов между сценами
└── persistent_data.gd    # Сохранение данных между сценами

Levels/                    # Уровни игры
├── level.tscn            # Основной уровень
├── CastleLevel.tscn      # Замковый уровень
└── GIData/               # Данные глобального освещения
...
- **Singleton Pattern** - глобальные системы через autoload
- **Scene Management** - управление сценами и переходами
- **Data Persistence** - сохранение состояния между сценами

## 🚀 Планы развития

- [x] ~~Система экипировки оружия~~ ✅ Реализовано
- [x] ~~Сохранение/загрузка игры~~ ✅ Частично реализовано (между сценами)
- [x] ~~Система лута и предметов~~ ✅ Реализовано
- [ ] Диалоги и квесты
- [ ] Улучшенная ИИ врагов
- [ ] Система магии и заклинаний
- [ ] Звуковое сопровождение
- [ ] Улучшение VFX эффектов
- [ ] Система торговцев и магазинов
...
- Плавные переходы с fade анимацией
- Сохранение состояния игрока через PersistentData
- Автоматическое восстановление экипировки и характеристик
- Визуальные порталы для интуитивной навигации

### Архитектура синглтонов
- VfxManager - глобальное управление визуальными эффектами
- SceneTransition - система переходов между сценами
- PersistentData - сохранение данных между сценами
